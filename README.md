...
Version `0.0.1` ships Hermes iOS build `260318099.0.1`. A GitHub Release on that tag holds `hermesvm.xcframework.zip` and a matching macOS `hermesc`. Compiler and VM match.
